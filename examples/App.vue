<template>
  <div id="app">
    ...
    <qk-button size="large" shape="circle">圆</qk-button>
    <qk-button long>长</qk-button>
    <qk-button-group shape="circle" size="large">
      <qk-button>成功</qk-button><qk-button>成功</qk-button><qk-button>成功</qk-button><qk-button>成功</qk-button>
      <qk-button>成功</qk-button>
    </qk-button-group>
  </div>
</template>
